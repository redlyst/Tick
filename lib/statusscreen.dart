...
class _StatusScreenState extends State<StatusScreen> {
  ...
  Widget _appBarTitle = new Text('Status');
  @override
  void initState() {
                                ...
                                child: new Card(
                                  ...
                                  child: new ListTile(
                                    ...
                                    title: Column(
                                      ...
                                      children: <Widget>[
                                        Text(snapshot.data[i]['status_id']),
                                        Text(
                                          snapshot.data[i]['status_name'],
                                          style: TextStyle(
  ...
  Future<List> getList() async {
    ...
    var dio = Dio();
    Response response = await dio.get("http://10.2.49.12/it_is/Api/getStatus");
